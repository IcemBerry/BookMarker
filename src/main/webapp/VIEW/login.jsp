...
<div class="container">
    ...
    <div class="well col-md-6 col-md-offset-3" id="loginBox">
        <form class="form-horizontal" action="/login" method="post">
            <div class="alert alert-info">还没有账号？<a href="#">立即注册</a></div>
            <div class="form-group">
                <div class="col-md-12">
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-user" style="color: #7ba23f"></span>
                        </span>
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon ">
                            <span class="glyphicon glyphicon-leaf" style="color: #7ba23f"></span>
                        </span>
